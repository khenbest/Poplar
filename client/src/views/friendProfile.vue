      ...
      <div class="col-12">
        ...
        <div id="btn-bar" class="row d-flex justify-content-center">
          <div class="row d-flex justify-content-center">
            ...
            <button class="btn btn-my" @click="showPosts = false">Participated Posts</button>
          </div>
        </div>
        <div class="row d-flex justify-content-center">
        ...
        <div class="row justify-content-center mt-2">
          <div class="card col-2 mx-2">
            <h4 @click="showFollowedBy = !showFollowedBy">
              Followers:
              {{followedBy.length}}
            </h4>
            <div v-if="showFollowedBy" v-for="follows in followedBy">
              <li class="card-title text-dark">{{follows.name}}</li>
            </div>
          </div>
          <div class="card col-2 mx-2">
            <h4 @click="showFollowers = !showFollowers">
              Following:
              {{followers.length}}
            </h4>
            <div v-if="showFollowers" v-for="follows in followers">
